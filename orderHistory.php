...
?>
	<div class="col-md-10" style="background:#D5D8DC;min-height:730px;">
		...
		echo "<div class='col-md-1 game'>";
			echo "<center><h4 style='color:black;'><u>Date</u></h4></center>";
		echo "</div>";
		echo "<div class='col-md-1 game'>";
			echo "<center><h4 style='color:black;'><u>Time</u></h4></center>";
		echo "</div>";
		...
		echo "<div class='col-md-3 game'>";
			echo "<center><h4 style='color:black;'><u>Total Amount</u></h4></center>";
		echo "</div>";
			...
			while($arr=mysqli_fetch_row($res))
			{
				...
				while($arr1=mysqli_fetch_row($res1))
				{
					...
					echo "</div>";
					echo "<div class='col-md-3 game' style='height:120px;top:45px'>";
						$sum=($arr[2]*$arr1[3]);
