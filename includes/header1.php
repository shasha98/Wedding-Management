...
<head>
  ...
  -->
  <link rel="stylesheet" href="/wedding/css/bootstrap.min.css">
  <!--custom core css-->
  <link rel="stylesheet" href="/wedding/css/style.css">
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
</head>
<body style="background: url('images/d.gif'); background-size: 100%;min-height:750px;min-width:750px;">
		...
		<nav class="navbar navbar-inverse navbar-fixed-top navbar-custom" style="background-color: #">
		  <div class="container-fluid">
			<div class="navbar-header">
			  ...
			  <img src="/wedding/images/7.png" style="width:70%">
			</div>
			<div class="collapse navbar-collapse" id="myNavbar">
			  ...
			  <!--Check, if username session is NOT set then this page will jump to login page-->
						<?php
							...
							{
								echo "<li><a href='myaccount1.php'><span class='glyphicon glyphicon-user'> MyAccount</span>";
							}	
							else
							{
						...
						<?php
							...
							else
							{
								...
								echo "<li><a href='login1.php'><span class='glyphicon glyphicon-log-in'> Admin</span>";
							}																																																				
						?>
				</a></li>
			  </ul>
